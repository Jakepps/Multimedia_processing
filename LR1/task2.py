...
img1 = cv2.imread(r'.\LR1\source\img1.jpg',cv2.IMREAD_GRAYSCALE)
img2 = cv2.imread(r'.\LR1\source\img2.png',cv2.IMREAD_REDUCED_COLOR_8)
img3 = cv2.imread(r'.\LR1\source\img3.bmp',cv2.IMREAD_ANYDEPTH)
